...
const PANEL_COLORS_RANGE = 'DIMENSIONS!A2:H14'; // Range for Glass Triplex options
...
const panelDimensionsList = ['450X2100', '500X2250', '900X1050', '900X2100', '1000X2250', '1250X2500'];
    ...
    try {
        ...
        regularOptions.forEach(option => {
            ...
            switch (panelDimension) {
                ...
                case '1250X2500': cost = option[7]; break;
                default: cost = null;
            }
...
function getCostValue(elementId) {
    ...
    if (element && element.textContent) {
        // Remove € symbol and spaces, then convert comma to dot for decimal
        const sanitizedValue = element.textContent
            .replace(/€/g, '')
            .replace(/\s/g, '')
            .replace(/\./g, '')
            .replace(',', '.');
